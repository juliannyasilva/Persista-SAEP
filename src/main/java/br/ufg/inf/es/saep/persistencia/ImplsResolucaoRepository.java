...
import br.ufg.inf.es.saep.dominio.CampoExigidoNaoFornecido;
import br.ufg.inf.es.saep.dominio.IdentificadorDesconhecido;
import br.ufg.inf.es.saep.dominio.Resolucao;
import br.ufg.inf.es.saep.dominio.ResolucaoRepository;
import br.ufg.inf.es.saep.dominio.Tipo;
import java.util.List;
import br.ufg.inf.es.saep.persistencia.DaoResolucao;
